...
/**
 * Table primitives. The wrapper scrolls horizontally on narrow screens so a
 * wide table never causes page-level horizontal scroll. Header row sits on
 * the muted surface; rows get the accent hover used by list items.
 */
