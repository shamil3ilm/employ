...
const TARGETS: Target[] = [
  ...
  { name: 'todos-board', path: '/todos?view=board' },
  { name: 'contacts-board', path: '/contacts?view=board' },
  { name: 'discoveries-board', path: '/discoveries?view=board' },
  { name: 'applications-board', path: '/applications?view=board' },
